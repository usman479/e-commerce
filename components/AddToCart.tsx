...
import { getCartStatus } from '@/redux/features/cart/cartSlice';
...
export default function AddToCart({ price, productId }: { price: number, productId: string }) {
    ...
    return (
        <>
            ...
            <div className='flex items-center mt-4  gap-x-4'>
                <button disabled={disableButton} className={cn('flex items-center  text-white py-2 px-4 select-none', {
                    'bg-gray-900': !disableButton,
                    'bg-gray-500': disableButton
